...
This AI system follows a structured agent pipeline:
**Input Data → Model → Agent → Tools → Decision**

This agent uses historical data from the FRA Blocked Crossings Portal [dataset](https://www.fra.dot.gov/blockedcrossings/incidents), filtered to Houston, Texas between the dates of 1-1-20 and 4-20-2026 which resulted in 20,783 records. After data preprocessing and cleaning the dataset was reduced to 16,864 records which were then used to train the GRU deep learning model. 
